...
const UIActions = {
  ...
  openConnectionTypeDialog() {
    AppDispatcher.dispatch({
      actionType: AppConstants.CONNECTION_TYPE_DIALOG_OPEN,
    });
  },
  ...
  openNumberInputDialog: function(onInput, number) {
    AppDispatcher.dispatch({
  ...
  openTextInputDialog: function (callback, text, input, title) {
    AppDispatcher.dispatch({
      actionType: AppConstants.OPEN_TEXT_INPUT_DIALOG,
      callback,
      text,
      input,
      title
  ...
  toggleBuildCaseStep: function (currentStep) {
    AppDispatcher.dispatch({
      actionType: AppConstants.TOGGLE_CASE_STEP,
      currentStep
    });
  },
  buildCaseStepRepeat: function (initialStep) {
    AppDispatcher.dispatch({
      actionType: AppConstants.CASE_STEP_REPEAT,
      initialStep
    });
  },
  startGuide: function(guideType) {
    AppDispatcher.dispatch({
      actionType: AppConstants.START_GUIDE,
      guideType
    });
  },
  toggleGuide:function (obj) {
    AppDispatcher.dispatch({
      actionType: AppConstants.TOGGLE_GUIDE,
      type: obj.type,
      title: obj.title,
      text: obj.text,
  ...
  showHitGuide: function () {
    AppDispatcher.dispatch({
      actionType: AppConstants.SHOW_HIT_GUIDE,
    });
  },
  showDragGuide: function (bounding) {
    AppDispatcher.dispatch({
      actionType: AppConstants.SHOW_DRAG_GUIDE,
      bounding: bounding
    });
  },
  enableJumpToNextGuideStep() {
    AppDispatcher.dispatch({
      actionType: AppConstants.ENABLE_JUMP_TO_NEXT_GUIDE_STEP,
    });
  },
  jumpToNextGuideStep(){
    AppDispatcher.dispatch({
      actionType: AppConstants.JUMP_TO_NEXT_GUIDE_STEP,
    });
  }
};
