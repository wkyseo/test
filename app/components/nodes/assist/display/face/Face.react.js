...
class FaceNode extends PureComponent {
  ...
  renderFaceIcon(){
    ...
    case 'angry':
      icon =  (<div className='node-actual-icon' style={{backgroundImage: 'url("img/face/face-angry-onNode.png")'}}></div> );
      break;
    case 'drowsy':
      icon =  (<div className='node-actual-icon' style={{backgroundImage: 'url("img/face/face-drowsy-onNode.png")'}}></div> );
      break;
    case 'enlarged':
      icon =  (<div className='node-actual-icon' style={{backgroundImage: 'url("img/face/face-enlarged-onNode.png")'}}></div> );
      break;
    case 'fixed':
      icon =  (<div className='node-actual-icon' style={{backgroundImage: 'url("img/face/face-fixed-onNode.png")'}}></div> );
      break;
    case 'happy':
      icon =  (<div className='node-actual-icon' style={{backgroundImage: 'url("img/face/face-happy-onNode.png")'}}></div> );
      break;
    case 'mini':
      icon =  (<div className='node-actual-icon' style={{backgroundImage: 'url("img/face/face-mini-onNode.png")'}}></div> );
      break;     
    case 'normal':
      icon =  (<div className='node-actual-icon' style={{backgroundImage: 'url("img/face/face-normal-onNode.png")'}}></div> );
      break;
    case 'sad':
      icon =  (<div className='node-actual-icon' style={{backgroundImage: 'url("img/face/face-sad-onNode.png")'}}></div> );
      break;    
    }
    return icon;
  }  
