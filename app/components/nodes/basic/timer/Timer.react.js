      ...
      <div className={'node-actual node-type-' + this.props.info.name} id={this.props.id} style={{
        ...
        <div className='node-body node-draggable'>
          <div className='node-actual-body'>
            <span className="node-actual-interval node-actual-content-title">{languages.getTranslation('timer')}</span>
            <div className="node-interval-wrap node-actual-content-wrap">
              <span className={'node-actual-time node-actual-content-text '+((this.state.value>9999 || this.state.value<-9999)? 'hide-more': '')}>{this.state.value}</span>
