    ...
    return (
      <div className={'node-actual node-type-' + this.props.info.name} id={this.props.id} style={{
        ...
        <div className='node-body node-draggable'>
          <div className='node-actual-body' style={{backgroundImage:'url(./img/number-arrow.png)'}}>
            <div className={'number-node text-node '+((this.state.value>9999 || this.state.value<-9999)? 'hide-more': '')}>{this.state.value}</div>
          </div>
        </div>
