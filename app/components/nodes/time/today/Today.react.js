      ...
      <div className={'node-actual node-type-' + this.props.info.name} id={this.props.id} style={{
        ...
        <div className='node-body node-draggable hide-config'>
          <div className='node-actual-body'>
            <span className="date node-actual-content-title">{this.getMonth(this.state.month)}{languages.getTranslation('another-month')}{this.state.day}{languages.getTranslation('another-day')}</span>
            <span className="week node-actual-content-wrap">{languages.getTranslation('another-week')}{this.getWeek(this.state.week)}</span>
          </div>
        </div>
