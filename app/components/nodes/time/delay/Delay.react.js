      ...
      <div className={'node-actual node-type-' + this.props.info.name} id={this.props.id} style={{
        ...
        <div className='node-body node-draggable'>
           <div className='node-actual-body'>
            <span className='delay-title node-actual-content-title'>{languages.getTranslation('delay')}</span>
             <div className="delay-number-wrap node-actual-content-wrap">
               <span className={'delay-value node-actual-content-text '+((this.state.delay>9999 || this.state.delay<-9999)? 'hide-more': '')}>{this.state.delay}</span>
