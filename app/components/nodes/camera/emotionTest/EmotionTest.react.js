...
class EmotionTestNode extends PureComponent {
  ...
  getEmotionIcon() {
    ...
    case 'happiness':
      url = './img/emotion/icon-happiness-onNode.png';
      break;
    case 'anger':
      url = './img/emotion/icon-anger-onNode.png';
      break;
    case 'sadness':
      url = './img/emotion/icon-sadness-onNode.png';
      break;
    case 'fear':
      url = './img/emotion/icon-fear-onNode.png';
      break;
    case 'surprise':
      url = './img/emotion/icon-surprise-onNode.png';
      break;
    }
