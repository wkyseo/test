      ...
      <div className={'node-actual node-type-' + this.props.info.name} id={this.props.id} style={{
        ...
        <div className='node-body node-draggable'>
           <div className='node-actual-body'>
            <span className="node-button-panel-title">{languages.getTranslation('random')}</span>
            <span className="node-button-panel-value">{this.state.number}</span>    
            <span className="node-button-panel-btn" {...tapOrClick(this.onTrigger.bind(this))}>{languages.getTranslation('trigger')}</span>
          </div>       
        </div>
