...
class FunctionNode extends PureComponent {
  ...
  getIconUrl(){
    ...
    case '10^':
      ...
      break;
    case 'sin':
      url = (<div className='node-actual-icon'><img src='./img/node-function-sin-icon.png'/></div>);
      break;
    case 'cos':
      url = (<div className='node-actual-icon'><img src='./img/node-function-cos-icon.png'/></div>);
      break;
    case 'tan':
      url = (<div className='node-actual-icon'><img src='./img/node-function-tan-icon.png'/></div>);
      break;
    case 'asin':
      url = (<div className='node-actual-icon'><img src='./img/node-function-asin-icon.png'/></div>);
      break;
    case 'acos':
      url = (<div className='node-actual-icon'><img src='./img/node-function-acos-icon.png'/></div>);
      break;
    case 'atan':
      url = (<div className='node-actual-icon'><img src='./img/node-function-atan-icon.png'/></div>);
      break;
    case 'round':
      url = (<div className='node-actual-icon'><img src='./img/node-function-round-icon.png'/></div>);
      break;
    case 'floor':
      url = (<div className='node-actual-icon'><img src='./img/node-function-floor-icon.png'/></div>);
      break;
    case 'ceil':
      url = (<div className='node-actual-icon'><img src='./img/node-function-ceil-icon.png'/></div>);
      break;
    default:
      url = (<div className='node-actual-icon'>{this.state.func}</div>);
      break;    
    }
    console.log(url);
    return url;
