...
//MultiTouch for nodePort
NodeUtils.setPortTouchInfo = function (enlargedList, shrinkedList, enlargedNode, enlargedPort){
  NodeUtils.portTouchObj = {
    enlargedList,
    shrinkedList,
    enlargedNode,
    enlargedPort
...
NodeUtils.getPortTouchInfo = function(){
  return NodeUtils.portTouchObj;
};

NodeUtils.setIsPortTouch = function(boolean) {
  console.log('boolean:', boolean);
  NodeUtils.isPortTouch = boolean;
};

NodeUtils.getIsPortTouch = function() {
  return NodeUtils.isPortTouch;
};
