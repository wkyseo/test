         ...
         <div className="field-con">
           <div className="field-tpl computer-vision" ref="computerVisionWrap">
             ...
             <div className="input-div">
               <input type="text" className="field-input computer-input" ref="computerVisionInput" onFocus={this.focus.bind(this)}/>
           ...
           <div className="field-tpl emotion" ref="emotionWrap">
             ...
             <div className="input-div">
               <input type="text" className="field-input emotion-input" ref="emotionInput" onFocus={this.focus.bind(this)}/>
               <span className="clear-icon" {...tapOrClick(this.clearInputText)}>x</span>
             </div>
           ...
           <div className="field-tpl bing-speech" ref="bingSpeechWrap">
             ...
             <div className="input-div">
               <input type="text" className="field-input speech-input" ref="bingSpeechInput" onFocus={this.focus.bind(this)}/>
               <span className="clear-icon" {...tapOrClick(this.clearInputText)}>x</span>
             </div>
