...
class SoundSelect extends Component {
  constructor() {
    ...
    this.state = {
      ...
      id: this.props.id,
      curTab: nodeStore.getCurrentConfig(this.props.id, 'soundType') || this.props.config.soundType.defaultValue,
      soundEffect: nodeStore.getCurrentConfig(this.props.id, 'soundEffect') || this.props.config.soundEffect.defaultValue,
      reRender: false
    };
