...
let factory = {
  ...
  ACCELEROMETER_GYRO: {
    type: [
      {key:'shake', value: languages.getTranslation('shake')},
      {key:'angle', value: languages.getTranslation('angle')},
      {key:'acceleration', value: languages.getTranslation('acceleration')}
    ],
    axis: [
      {key:'X', value: 'X'},
      {key:'Y', value: 'Y'},
