...
/*  getDeviceName() {
  ...
  getGuideConnectResult() {
    return this.guideConnectResult;
  }

  setGuideConnectResult(boolean=false) {
    this.guideConnectResult = boolean;
  }
}
...
AppDispatcher.register((action) => {
  if (action.actionType == AppConstants.LINK_AUTO_CONNECT_DIALOG_OPEN) {
    ...
    //新手引导蓝牙连接成功的判断依据
    _instance.guideConnectResult = true;
